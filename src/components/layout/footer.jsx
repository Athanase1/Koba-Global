...
export default function Footer({}) {
  ...
  return (
    <footer>
      ...
      <p style={{fontSize:"10px"}}>Site par:<a href="https://athanase1.github.io/Moi/"  target="_blank" rel="noopener noreferrer" style={{color:"gray", fontSmooth:"smooth", cursor:"pointer", textDecoration:"underline", fontSize:"10px"}}>Athanase Kpan</a> &copy;</p>
    </footer>
  );
}
