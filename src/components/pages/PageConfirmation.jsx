    ...
    return <div className="container">
      ...
      <tbody>
        ...
        <div className="info-contact">
            ...
            <h1>Nom d'épicerie: <span>{champs.nomEpic}</span> </h1>
            <h1>Nom du responsable: <span>{champs.nomRes}</span> </h1>
            <h1>addresse: <span>{champs.addresse}</span></h1>
            <h1>Email: <span>{champs.email}</span></h1>
            <h1>Numéro de telephone: <span>{champs.tel}</span> </h1>
        </div>
        <div className="btns">
            <button onClick={() => navigate("/panier")}>Retour au panier</button>
            <button onClick={() => alert("Commande envoyer avec succèss!")}>Envoyer la commande à Distributions kobal Global</button>
        </div>
    </div>
}
